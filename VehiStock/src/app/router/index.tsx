...
import { CustomerDetailsPage } from '@/pages/staff/customer-details-page'
import { SearchCustomersPage } from '@/pages/staff/search-customers-page'
import { SellPartsPage } from '@/pages/staff/sell-parts-page'
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route element={<RoleRoute allowedRoles={[ROLE_NAMES.staff]} />}>
          <Route path="staff" element={<StaffLayout />}>
            ...
            <Route path="sell-parts" element={<SellPartsPage />} />
