...
export const ROUTE_PATHS = {
  ...
  staff: {
    dashboard: '/staff',
    searchCustomers: '/staff/search-customers',
    customerDetails: '/staff/customer-details',
    sellParts: '/staff/sell-parts',
    customerDetailsWithId: (customerId: number) =>
      `/staff/customer-details?customerId=${customerId}`,
    sellPartsWithId: (customerId: number) => `/staff/sell-parts?customerId=${customerId}`,
...
const pageMetaEntries: Array<{ path: string; meta: PageMeta }> = [
  ...
  {
    path: ROUTE_PATHS.staff.searchCustomers,
    meta: {
      title: 'Search customers',
      subtitle: 'Find customers by name, phone, vehicle number, ID, or email.',
    },
  },
  {
    path: ROUTE_PATHS.staff.customerDetails,
    meta: {
      title: 'Customer details',
      subtitle: 'View profile, vehicles, and purchase history.',
    },
  },
  {
    path: ROUTE_PATHS.staff.sellParts,
    meta: {
      title: 'Sell parts',
      subtitle: 'Record a part sale for a customer and vehicle.',
    },
  },
  {
